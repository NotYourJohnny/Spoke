...
client.on("ready", () => {
    ...
    let ActiOptions = ["STREAMING", "STREAMING", "STREAMING", "STREAMING"];
    setInterval(function () {
        // Randomise
        let randomsieActivity = ActiOptions[Math.floor(Math.random() * ActiOptions.length)];
        // Activity
        client.user.setActivity({
            name: `;help | ${userCount} Users`,
            type: randomsieActivity,
            url: "https://www.twitch.tv/sex"
        });
...
client.login("OTI0NTQ4ODA0OTI4MjEzMDAz.YcgLLA.DkFKnkq1EssOPF5XTNcplkPluZU");
